...
import com.github.eltonsandre.discosvinil.api.repository.query.CatalogoRepositoryQuery;
 ...
 */
@Repository
public interface CatalogoRepository extends JpaRepository<Disco, Long>, CatalogoRepositoryQuery {
